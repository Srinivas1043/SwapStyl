...
-- 1. Drop the old unique constraint on (user1_id, user2_id, item_id)
ALTER TABLE public.conversations 
DROP CONSTRAINT IF EXISTS conversations_user1_id_user2_id_item_id_key;

-- 2. Add new unique constraint on just (user1_id, user2_id)
...
-- 3. Make item_id nullable since item info is now stored in message metadata
ALTER TABLE public.conversations 
